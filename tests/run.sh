...
echo "[1/7] linter passes on the real repo"
...
echo "[2/7] linter rejects the bad fixture for the right reason"
...
echo "[3/7] hooks behave (valid JSON output + guard inert when off)"
...
echo "[4/7] ledger + audit behavior"
...
echo "[5/7] run-report behavior + parity"
...
echo "[6/7] evolve detection + apply"
