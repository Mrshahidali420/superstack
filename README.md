...
**Supporting skills:** `/ss-debug` `/ss-guard` `/ss-respond` `/ss-worktree` `/ss-pause` `/ss-resume` `/ss-retro` `/ss-docs` `/ss-init` `/ss-doctor` — run `/ss-help` for the full index (**25 skills, 4 review agents, 2 hooks**).
