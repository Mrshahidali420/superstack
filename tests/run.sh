...
echo "[1/5] linter passes on the real repo"
...
echo "[2/5] linter rejects the bad fixture for the right reason"
...
echo "[3/5] hooks behave (valid JSON output + guard inert when off)"
...
echo "[4/5] ledger + audit behavior"
