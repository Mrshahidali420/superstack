...
echo "[1/6] linter passes on the real repo"
...
echo "[2/6] linter rejects the bad fixture for the right reason"
...
echo "[3/6] hooks behave (valid JSON output + guard inert when off)"
...
echo "[4/6] ledger + audit behavior"
...
echo "[5/6] run-report behavior + parity"
